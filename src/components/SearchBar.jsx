  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 lg:px-6">
      <div className="flex-1 relative">
        <div className="flex items-center bg-gray-100 dark:bg-gray-800 rounded-xl px-4 py-3 gap-3">
          ...
          />
          <button onClick={handleSearch} className="hover:bg-gray-200 dark:hover:bg-gray-700 p-1 rounded">
